    ...
    <div className='container'>
      ...
      <div className={styles.descriptions}>
        <p className={styles.text}>
          ...
          Ежегодные поездки в горы или на море стали традиционным событием. А интересные корпоративы
          у нас проходят чуть ли не каждый месяц.
        ...
        <p className={styles.text}>
          Часто мы просто собираемся на ужин в каком-нибудь месте, но иногда по какому-нибудь поводу
          можем забронировать крышу ресторана и устроить полноценное празднование.
        </p>
      </div>
      <ImagesSection
        widthMidImg={611}
      ...
      <div className={styles.description}>
        <p className={styles.text}>
          Те кто отдохнул вечером в караоке, отправляются с утра кататься в горы. Лагерь как всегда
          разделился, на сноубордистов и лыжников.
        </p>
      </div>
      <ImagesSection
        widthMidImg={431}
